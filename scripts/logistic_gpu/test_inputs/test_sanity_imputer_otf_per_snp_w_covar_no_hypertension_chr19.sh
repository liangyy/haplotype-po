...
CHUNKSIZE=30  # 30
NTHREADS=4
PHENO_F=test_inputs/test_phenotype_father_hypertension.yaml
COVAR_F=test_inputs/test_covariate.yaml
PROBZ=test_inputs/test_prob_z_imputer_otf_per_snp_w_covar_hypertension_chr19.yaml

# PROBZ=test_inputs/test_prob_z_flip.yaml
OUT=test_sanity_imputer_otf_per_snp_w_covar_hypertension_chr19.npy
